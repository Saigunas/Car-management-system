        ...
        <div class="grid grid-cols-1">
            <div class="w-full">
                <div class="bg-white dark:bg-gray-800 shadow-md rounded my-6">
                    <div class="px-6 py-4">
                        <div class="font-bold text-xl dark:text-gray-300">Savininkų sąrašas</div>
                        <div class="flex flex-row justify-between dark:text-gray-300 items-end">
                            <div class="owners-create">
                                <a href="{{ route('owners.create') }}" class="px-4 py-2 rounded-md text-white bg-green-500 hover:bg-green-600">Pridėti</a>
                            </div>
                        ...
                        <table class="table-auto w-full">
                            ...
                            @foreach($owners as $owner)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td>
                                        <a class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" href="{{route('owners.edit', $owner->id)}}">Redaguoti</a>
                                        <a class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" href="{{route('owners.delete',$owner->id)}}">Ištrinti</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
